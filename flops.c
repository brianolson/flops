...
/*******************************************************/
   ...
   T[1]  = scale;
   printf(" n=%10ld  sa=%12.5lf  scale=%12.5lf\n",n,sa,scale);
...
/****************************************/
   ...
   //printf( "x=%lf\ts=%lf\tsa=%lf\tsb=%lf\tscale=%lf\tn=%ld\n", x, s, sa, sb, scale, n );
   sc = sb - 25.2;
   T[4] = one / T[3];
						   /********************/
						   /*  DO NOT REMOVE   */
